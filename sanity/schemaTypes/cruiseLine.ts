  ...
  fields: [
    ...
    // — 12 At a Glance —
    {
      ...
      fields: [
        ...
        { name: 'dining', title: 'Dining', type: 'string' },
        { name: 'entertainment', title: 'Entertainment', type: 'string' },
        { name: 'destinations', title: 'Destinations', type: 'string' },
        { name: 'standoutFeature', title: 'Standout Feature', type: 'string' },
        { name: 'considerUpgradingTo', title: 'Consider Upgrading To', type: 'string' },
        { name: 'ourView', title: 'Our View', type: 'text', rows: 2 },
