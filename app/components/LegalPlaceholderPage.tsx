  ...
  return (
    <main style={{ fontFamily: "var(--font-jost), sans-serif", background: "var(--pearl)", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "700px", margin: "0 auto", padding: "100px 40px 120px", textAlign: "center" }}>
        <div style={{ fontFamily: "var(--font-jost), sans-serif", fontSize: "13px", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--teal-text)", fontWeight: 500, marginBottom: "16px" }}>Ocean & Safari</div>
